#!/bin/bash
#SBATCH --job-name=ol-v4s1-cfg-e32
#SBATCH --partition=inference-large
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=8
#SBATCH --mem=64G
#SBATCH --time=06:00:00
#SBATCH --output=logs/v4_s1_cfg_ft_heun50_ens32_%j.out
#SBATCH --error=logs/v4_s1_cfg_ft_heun50_ens32_%j.err
...
OUT_DIR=/scratch/emboulaalam/OceanLens_git/results/v4_s1_cfg_ft_inference/heun50_sigma10_ens32_cfg10
...
python scripts/plot_thetao_residuals.py \
  ...
  --title "v4_s1_logit_t_cfg_ft | Heun50 | sigma=1.0 | ens=32 | cfg=1.0 | tile512 ov128"
