#!/bin/bash
#SBATCH --job-name=ol-v8a-dit-inf
#SBATCH --partition=inference-large
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=8
#SBATCH --mem=64G
#SBATCH --time=6:00:00
#SBATCH --output=logs/v8a_dit_pixel_infer_%j.out
#SBATCH --error=logs/v8a_dit_pixel_infer_%j.err
...
OUT_DIR=${OUT_DIR:-/scratch/emboulaalam/OceanLens_git/results/v8a_dit_pixel_inference/heun50_sigma10_ens1}
...
python scripts/plot_thetao_residuals.py \
  ...
  --title "v8a DiT | Heun 50 | sigma=1.0 | ens=1 | 2004-01-01"
